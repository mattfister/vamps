...
class Turret(Enemy):
    def __init__(self, x, y, facing, state):
        Enemy.__init__(self, x, y, facing, 3, [0, 0, 32, 32], state, 'sprites', [3*32, 7*32, 32, 32], state.batch, state.enemy_group)
    ...
    def create_animations(self):
        self.add_animation('walkRight', [[3*32, 7*32, 32, 32], [4*32, 7*32, 32, 32]], fps=10.0)
        self.add_animation('walkLeft', [[3*32, 8*32, 32, 32], [4*32, 8*32, 32, 32]], fps=10.0)
